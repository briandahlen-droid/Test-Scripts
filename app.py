...
def lookup_hillsborough_zoning_flu(address, folio=None, geometry=None):
    ...
    try:
        ...
        # Query Hillsborough County ZONING - correct layer with NZONE fields
        ...
        # Use the Zoning FeatureServer (has NZONE, NZONE_DESC)
        ...
        zoning_params = {
            ...
            'outFields': 'NZONE,NZONE_DESC,CATEGORY,RZ,ACRES',
        ...
        if zoning_data.get('features'):
            ...
            # This layer has NZONE and NZONE_DESC fields
            ...
            st.write("DEBUG: Zoning query returned no features - coordinate might be outside zoning coverage area")
