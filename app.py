...
HILLSBOROUGH_FLU_CODES = {
    'A/M': 'Agricultural/Mining - 1/20',
    'A-1/10': 'Agricultural - 1/10',
    'AR-1/5': 'Agricultural/Rural - 1/5',
    'AE-1/2.5': 'Agricultural Estate - 1/2.5',
    'PEC-1/2': 'Planned Environmental Community - 1/2',
    'RES-1': 'Residential - 1',
    'RES-2': 'Residential - 2',
    'RP-2': 'Residential Planned - 2',
    'WVR-2': 'Wimauma Village Residential - 2',
    'NMU-4(3)': 'Neighborhood Mixed-Use - 4(3)',
    'NMU-6': 'Neighborhood Mixed-Use - 6',
    'RES-4': 'Residential - 4',
    'RES-6': 'Residential - 6',
    ...
    'RES-20': 'Residential - 20',
    'OC-20': 'Office Commercial - 20',
    'RES-35': 'Residential - 35',
    'UMU-20': 'Urban Mixed-Use - 20',
    'RMU-35': 'Regional Mixed-Use - 35',
    'ICMU-35': 'Innovation Corridor Mixed-Use - 35',
    'RCP': 'Research/Corporate Park',
    'LI-P': 'Light Industrial Planned',
    'LI': 'Light Industrial',
    'HI': 'Heavy Industrial',
    'EIP': 'Energy Industrial Park',
    'EIP-USA': 'Energy Industrial Park - Urban Service Area',
...
def get_hillsborough_flu_description(code):
    ...
    return HILLSBOROUGH_FLU_CODES.get(code_str, code_str)
...
def get_land_use_description(code_or_desc):
    ...
    # Remove decimal point if present (84.0 -> 84)
    if '.' in code_str:
...
def lookup_hillsborough_zoning_flu(address):
    ...
    try:
        ...
        if flu_data.get('features'):
            ...
            flu_desc = get_hillsborough_flu_description(flu_code)
            result['future_land_use'] = flu_desc if flu_desc else flu_code
