...
def lookup_hillsborough_zoning_flu(address, folio=None, geometry=None):
    ...
    try:
        ...
        st.write(f"DEBUG: Querying OFFICIAL Zoning Atlas with coords ({x}, {y})")
        ...
        # Official Hillsborough County Zoning Atlas service
        ...
        flu_params = {
            'where': '1=1',
            'geometry': f'{xmin},{ymin},{xmax},{ymax}',  # Use envelope like zoning
            'geometryType': 'esriGeometryEnvelope',
            'spatialRel': 'esriSpatialRelIntersects',
            'outFields': 'FLUE',
            'returnGeometry': 'false',
