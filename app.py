...
def lookup_hillsborough_zoning_flu(address, folio=None, geometry=None):
    ...
    try:
        ...
        # Query Hillsborough County zoning using same service as FLU (which works!)
        ...
        # Use Hillsborough County's official server (same as FLU)
        # Try layer 0 for zoning (FLU is layer 1)
        zoning_url = "https://maps.hillsboroughcounty.org/arcgis/rest/services/DSD_Viewer_Services/DSD_Viewer_Planning/MapServer/0/query"
